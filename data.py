...
if __name__ == '__main__':
  ...
  for month in range(1,13):
    ...
    while orders_amount > 0:
      ...
      # Add items to orders with random chance
      ...
      elif product_choice == "Google Phone" or product_choice == "Freebased Phone":
